...
describe('TasksService', () => {
    ...
    describe('create', () => {
        ...
        it('should create a task successfully', async () => {
            (prisma.projectMember.findUnique as jest.Mock).mockResolvedValue(mockProjectMember);
            (prisma.task.create as jest.Mock).mockResolvedValue(mockTask);
            (prisma.taskAssignee.createMany as jest.Mock).mockResolvedValue({ count: 2 });
    ...
    describe('updateStatus', () => {
        it('should update task status and create history', async () => {
            ...
            const result = await service.updateStatus(mockTaskId, mockUserId, TaskStatus.IN_PROGRESS);
